...
if REDIS_URL:
    ...
    CACHES = {
        "default": {
            ...
            "LOCATION": "autenticacion-local-cache",
        }
    }
...
USUARIOS_SERVICE_URL = os.environ.get("USUARIOS_SERVICE_URL", "http://localhost:8000").rstrip("/")
USUARIOS_SERVICE_TOKEN = os.environ.get("USUARIOS_SERVICE_TOKEN", "").strip()
